...
<head>
    ...
    <style>
        ...
        /* Table styles */
        .table thead th {
            background-color: #030303; /* Dark background for table headers */
        ...
        .badge-confirmed,
        .badge-paid {
            background-color: #28a745; /* Green color for confirmed and paid status */
        }

        .badge-return-requested {
            background-color: #17a2b8; /* Light blue color for return requested status */
        }
        ...
        /* Modal background */
        .modal-content {
            background-color: #1b2f34; /* Dark background for modal */
            color: #fff; /* White text color for modal content */
        }

        .modal-body button.btn {
            background-color: #ffc107; /* Yellow color for payment method buttons */
        }
    </style>
</head>
