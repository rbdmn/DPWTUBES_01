            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{asset('images/admin.jpg')}}" alt="" style="width: 40px; height: 40px;">
                        <div
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a id="transaksiLink" href="{{route('admin.transaksi')}}" class="nav-item nav-link active"><i
