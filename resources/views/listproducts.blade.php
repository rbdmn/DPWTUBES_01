    ...
    <div class="bg-darkgrey py-12" style="background-image: url('startbootstrap-grayscale-gh-pages/assets/img/campsite.jpg'); background-color: rgba(0, 0, 0, 0.5); background-blend-mode: multiply; background-size: cover; background-position: center;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <img src="https://fastly.picsum.photos/id/10/2500/700.jpg?hmac=-V8-VKooViy76bhIeIrdDOmdmtT6xTIiA3U2ff3hKcI" class="img-fluid" alt="test">
                <div class="p-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('cart.add', $item->id_barang) }}" method="POST">
                                            @csrf
                                            <input type="number" name="quantity" min="1" value="0" class="form-control input-small">
