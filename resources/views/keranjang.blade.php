        ...
        <div class="bg-darkgrey py-12"
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <img src="https://fastly.picsum.photos/id/27/2500/700.jpg?hmac=HrI6qndItZSp3ETIGODwF31Gkz66W-PebuoM0hVJdPw"
                                    ...
                                    <td>
                                        <form action="{{ route('cart.update', $item->id_keranjang) }}" method="POST">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="number" name="durasi" value="{{ $item->durasi }}" min="1"
                                                    class="form-control" style="width: 60px;" required>
                                                <button type="submit"
